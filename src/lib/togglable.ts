...
export type TogglableList<C extends NotUndefined<unknown>> = Togglable<undefined, C>;

export function togglable<T, C>(val: T, title: string, children: Togglable<C>[] | undefined = undefined): Togglable<T, C> {
  return {
    val,
    isOn: true,
    title,
