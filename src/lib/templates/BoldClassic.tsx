import { renderToStream, View, Document, Text, Page, StyleSheet, Link } from "@react-pdf/renderer"
...
function SummarySection(props: ResumeComponentProps) {
  ...
  return <ResumeSection name='Personal Summary'>
...
function SkillsSection(props: ResumeComponentProps) {
  ...
  return <ResumeSection name='Skills'>
...
function ResumeComponent(props: ResumeComponentProps) {
  ...
  return <Document>
    <Page style={[styles.page]} size='A4'>
      <Text style={[styles.bold, styles.name]}>{resume.basics.name}</Text>
