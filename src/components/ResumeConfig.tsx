/**
 * Widget used to configure and preview the resume
*/
...
/**
 * @field resume: Resume
 *      the configured resume setup so all of the fields in it are togglable
 * @field baseResume: JSONResume
 *      the overall profile that follows the JSON resume schema https://jsonresume.org/
 *      to include all fields that there may be in the resume.
 * @field setResume: Callable
 *      the method to be used when the resume is updated
 * @field template: Template
 *      the template used to generate the resume
 */
...
export default function ResumeConfig(props: ResumeConfigProps) {
    ...
    /**
     * Generate an artificial anchor tag to download the PDF
     *
     * NOTE: needed to be done due to the API route being a POST request
    */
