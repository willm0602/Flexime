/**
 * Component used to toggle certain fields of a parent
...
/**
 * @field parent: P
 *      the parent that we are updating a field on
 * @field fieldName: String
 *      the field of P that we are updating
 * @field togglable: Togglable
 *      the togglable component that we are modifying
 * @field setParent: Callable
 *      method to update the parent field
 * @field indent: number
 *      how indented the togglable field is
 */
