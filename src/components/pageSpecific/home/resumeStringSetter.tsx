...
export default function ResumeStringSetter<P>(
    props: ResumeStringSetterProps<P>
) {
    const { parent, fieldName, defaultVal, setParent, className } = props
    ...
    return (
        <label className="form-control flex flex-col w-full max-w-xs mr-8">
            <div className="label">
