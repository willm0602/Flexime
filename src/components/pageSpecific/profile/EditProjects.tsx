/**
 * Edit the projects section of the resume
*/
...
const RenderProject: ListItem<Project> = (props) => {
    ...
    const [highlights, dispatchHighlights] = useState<string[]>(
        project.highlights
    );
    const [url, dispatchURL] = useState<string | undefined>(project.url);
    const [sourceCode, dispatchSourceCode] = useState<string | undefined>(project.sourceCode);
    ...
    return (
        <>
            ...
            <div className='flex'>
                <EditableText defaultVal={name} dispatch={setName} label="Title" />
                <EditableText defaultVal={url || ''} dispatch={setURL} label="URL" />
                <EditableText defaultVal={sourceCode || ''} dispatch={setSourceCode} label="Source Code" />
            </div>
            <EditList
                vals={highlights}
